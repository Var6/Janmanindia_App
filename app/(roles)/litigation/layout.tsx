...
const navItems = [
  { href: "/litigation", label: "Dashboard" },
  { href: "/litigation/cases", label: "My Cases" },
  { href: "/litigation/appointments", label: "Appointments" },
  { href: "/training", label: "Training" },
];

export default async function LitigationLayout({
  children,
}: {
    ...
    <div className="flex h-screen bg-[var(--bg)] overflow-hidden">
      <aside className="w-64 shrink-0 bg-[var(--surface)] border-r border-[var(--border)] flex flex-col">
        <div className="px-6 py-5 border-b border-[var(--border)]">
          ...
          <p className="text-xs text-[var(--muted)] mt-0.5">Litigation Team</p>
        </div>
